        ...
        <div>
            <div className="d-flex justify-content-center my-5">
                <form style={{maxWidth: '450px', minWidth: '280px'}} className="d-flex flex-column p-5 shadow-lg rounded" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input className="my-2" placeholder="Full Name" {...register("fullName", { required: true})} value={user?.displayName} />
                    <input className="my-2" placeholder="Email" typw="email" {...register("email", { required: true })} value={user?.email} />
